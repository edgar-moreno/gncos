...
<nav>
	<ul>
		<li><a href="#">Nomina Principal</a></li>
								...
								<div class="form-group">
									<div class="form-row">
										<div class="col-3">
											...
											<input type="text" name="Documento" class="form-control" id="Documento" placeholder="Ej. 1189191023" value="{{ old('Documento') }}" >
											<span class="help-block">{{ $errors->first('Documento')}}</span>	
										</div>

										<div class="col">
											<label for="CentroDeCostos" class="col-form-label-sm">CentroDeCostos</label>
											<input type="text" name="CentroDeCostos" class="form-control" id="CentroDeCostos" placeholder="CentroDeCostos" value="{{ old('CentroDeCostos') }}" >
											<span class="help-block">{{ $errors->first('CentroDeCostos')}}</span>	
										</div>

										<div class="col">
											<label for="Supervisor" class="col-form-label-sm">Supervisor</label>
											<input type="text" name="Supervisor" class="form-control" id="Supervisor" placeholder="Supervisor" value="{{ old('Supervisor') }}" >
								...
								<div class="form-group">
									<div class="form-row">
										<div class="col">
											...
											<input type="text" name="NombreCompleto" class="form-control" id="NombreCompleto" placeholder="NombreCompleto" value="{{ old('NombreCompleto') }}" >
											<span class="help-block">{{ $errors->first('NombreCompleto')}}</span>	
										</div>

										<div class="col">
											<label for="Dias" class="col-form-label-sm">Dias</label>
											<input type="text" name="Dias" class="form-control" id="Dias" placeholder="Dias" value="{{ old('Dias') }}" >
											<span class="help-block">{{ $errors->first('Dias')}}</span>	
										</div>

										<div class="col-6">
											<label for="Sueldo" class="col-form-label-sm">Sueldo</label>
											<input type="text" name="Sueldo" class="form-control" id="Sueldo" placeholder="Sueldo" value="{{ old('Sueldo') }}" >
								...
								<div class="form-group">
									<div class="form-row">
										<div class="col">
											...
											<input type="text" name="AuxilioDeTransporte" class="form-control" id="AuxilioDeTransporte" placeholder="AuxilioDeTransporte" value="{{ old('AuxilioDeTransporte') }}" >
										...
										<div class="col">
											...
											<input type="text" name="HorasExtrasDiurnas" class="form-control" id="HorasExtrasDiurnas" placeholder="HorasExtrasDiurnas" value="{{ old('HorasExtrasDiurnas') }}" >
								...
								<div class="form-group">
									<div class="form-row">
										<div class="col">
											...
											<input type="text" name="AuxilioDeTransporteExtra" class="form-control" id="AuxilioDeTransporteExtra" placeholder="AuxilioDeTransporteExtra" value="{{ old('AuxilioDeTransporteExtra') }}" >
										...
										<div class="col-9">
											...
											<input type="text" name="Vacaciones" class="form-control" id="Vacaciones" placeholder="Vacaciones" value="{{ old('Vacaciones') }}" >
								...
								<div class="form-group">
									<div class="form-row">
										<div class="col">
											...
											<input type="text" name="Bonificacion" class="form-control" id="Bonificacion" placeholder="Bonificacion" value="{{ old('Bonificacion') }}" >
								...
								<div class="form-group">
									<div class="form-row">
										...
										<div class="col">
											...
											<input type="text" name="DominicalYFestivo" class="form-control" id="DominicalYFestivo" placeholder="DominicalYFestivo" value="{{ old('DominicalYFestivo') }}" >
									...
									<div class="form-row">				
										...
										<div class="col">
											...
											<input type="text" name="RecargoNocturno" class="form-control" id="RecargoNocturno" placeholder="RecargoNocturno" value="{{ old('RecargoNocturno') }}" >
									...
									<div class="form-row">
										...
										<div class="col">
											...
											<input type="text" name="AporteSalud" class="form-control" id="AporteSalud" placeholder="AporteSalud" value="{{ old('AporteSalud') }}" >
									...
									<div class="form-row">
										...
										<div class="col">
											...
											<input type="text" name="LibranzasyPrestamos" class="form-control" id="LibranzasyPrestamos" placeholder="LibranzasyPrestamos" value="{{ old('LibranzasyPrestamos') }}" >
									...
									<div class="form-row">
										...
										<div class="col">
											...
											<input type="text" name="MayorValorPagado" class="form-control" id="MayorValorPagado" placeholder="MayorValorPagado" value="{{ old('MayorValorPagado') }}" >
									...
									<div class="form-row">
										...
										<div class="col">
											...
											<input type="text" name="DescuentoDiadema" class="form-control" id="DescuentoDiadema" placeholder="DescuentoDiadema" value="{{ old('DescuentoDiadema') }}" >
									...
									<div class="form-row">
										...
										<div class="col">
											...
											<input type="text" name="FechaIngreso" class="form-control" id="FechaIngreso" placeholder="FechaIngreso" value="{{ old('FechaIngreso') }}" >
